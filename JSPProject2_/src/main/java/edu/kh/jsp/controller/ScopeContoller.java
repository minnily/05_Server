...
// 서블릿 매핑에서 유효하지 않은 url pattern... 이러한 오류 발생!
@WebServlet("/scope")
public class ScopeContoller extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 1. page scope -> JSP에서 확인 (page scope는 jsp 파일 내에서만 사용가능)
...
//		ServletContext application = session.getServletContext();
		...
		// ** 모든 scope는 속성을 세팅하고 얻어오는 방법이 동일함! **
		
		//*************************************************************
		
		// 우선 순위 확인 & scope 생명주기 호가인
