...
<head>
<meta charset="UTF-8">
<title><%= request.getParameter("singerList") %>의 PlayList</title>
</head>
<body>
	...
	<% if(request.getParameter("singerList")==("1. DAY6")) { %>
			<%= request.getParameter("/song1") %>
	<% } else if(request.getParameter("singerList")==("2. LUCY")) {%>
   			<%= request.getParameter("/song2") %>
		<% } else if(request.getParameter("singerList")==("3. JANNABI")) {%>
