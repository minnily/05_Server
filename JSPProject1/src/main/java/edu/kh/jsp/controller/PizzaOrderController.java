...
public class PizzaOrderController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		pizzaList.add(new Pizza("불고기피자",10000));
		pizzaList.add(new Pizza("고구마피자",9000));
		pizzaList.add(new Pizza("페퍼로니피자",9000));
		
		
		String pizza = req.getParameter("pizza");//값이 1,2,3,4 중 하나
		String size = req.getParameter("size"); //값이 R,L 중 하나
